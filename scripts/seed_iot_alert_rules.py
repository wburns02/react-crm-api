...
DEFAULT_RULES = [
    ...
    {
        "name": "Pump Excessive Cycles Per Day",
        "description": "Effluent pump cycled more than 24 times in a single day — likely stuck float or undersized tank.",
        "rule_type": "threshold_gt",
        "sensor_type": "pump_cycles_today",
        "alert_type": "pump_short_cycle",
        "severity": "medium",
        "config": {"threshold": 24, "unit": "count"},
        "message_template": "{device_serial} pump cycled {value:.0f} times today — investigate.",
    },
    {
        "name": "Pump Excessive Duty Cycle",
        "description": "Pump running >10% of the day — drain field backpressure, oversized inflow, or undersized tank.",
        "rule_type": "threshold_gt",
        "sensor_type": "pump_duty_pct",
        "alert_type": "pump_short_cycle",
        "severity": "medium",
        "config": {"threshold": 10.0, "unit": "pct"},
        "message_template": "{device_serial} pump duty cycle at {value:.1f}% today.",
    },
    {
        "name": "Pump Cycle Peak Overcurrent",
        "description": "Single pump cycle exceeded stalled-rotor current threshold — pump may be jammed or seized.",
        "rule_type": "threshold_gt",
        "sensor_type": "pump_cycle",
        "alert_type": "pump_overcurrent",
        "severity": "high",
        "config": {"threshold": 480, "unit": "s"},
        "message_template": "{device_serial} pump ran {value:.0f}s in one cycle — likely stuck on.",
    },
    {
