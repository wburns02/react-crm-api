...
class SepticPermit(Base):
    ...
    # Stored as JSON array for cross-database compatibility (PostgreSQL + SQLite)
    ...
    # Declared as Text for cross-database compatibility; actual column is tsvector in PostgreSQL
