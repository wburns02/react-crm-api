...
STREET_SUFFIXES = {
    ...
    'ARCADE': 'ARC',
    'AVENUE': 'AVE', 'AVENU': 'AVE', 'AVEN': 'AVE', 'AVNUE': 'AVE', 'AV': 'AVE',
    'BAYOU': 'BYU', 'BAYOO': 'BYU',
    'BEACH': 'BCH',
    'BEND': 'BND',
    'BLUFF': 'BLF', 'BLUF': 'BLF',
    'BLUFFS': 'BLFS',
    'BOTTOM': 'BTM', 'BOTTM': 'BTM', 'BOT': 'BTM',
    ...
    'STRAVENUE': 'STRA', 'STRAV': 'STRA', 'STRAVEN': 'STRA', 'STRAVN': 'STRA', 'STRVN': 'STRA', 'STRVNUE': 'STRA',
...
def compute_address_hash(
    ...
    normalized_county: Optional[str],
...
if __name__ == "__main__":
    ...
    print("-" * 60)
    addr, county, state, hash_val = normalize_and_hash(
        "123 N. Main Street, Apt 4B",
        "Travis County",
        "Texas"
    )
